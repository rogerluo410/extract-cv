...
def main():
  ...
  str2 = 'Personal Information: Name:                       Yang Jialin   Gender: Male Working Experience: 1 years'
  #for i in range(0,len(str2)):
       
  test2 = re.search('(name|Name|NAME)+',str2)
  print test2.group()
  test1 = re.search('(name|Name|NAME)+([\:|\s|\,]{1,})+([A-Z]{1}[A-Za-z]+\s{1})([A-Z]{1}[A-Za-z]+)?',str2)
  print test1.group()
